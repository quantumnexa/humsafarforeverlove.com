...
<body>
    ...
    <form class="form-inline" id='PayFast_payment_form' name='PayFast-payment-form' method='post'
        ...
        MERCHANT_NAME: <input type="TEXT" name="MERCHANT_NAME" value="Merchant Test" /><br /> <br>
        ...
        SUCCESS_URL: <input type="TEXT" name="SUCCESS_URL" value="https://humsafarforeverlove.com/payment/success" /><br /> <br>
FAILURE_URL: <input type="TEXT" name="FAILURE_URL" value="https://humsafarforeverlove.com/payment/failure" /><br /> <br>
CHECKOUT_URL: <input type="TEXT" name="CHECKOUT_URL" value="https://humsafarforeverlove.com/payment/checkout" /><br /> <br>
